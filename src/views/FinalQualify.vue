...
<template>
  <main class="border shadow view-main">
    ...
    <div class="p-lg-4 p-1 p-sm-0">
      <h2>7. Qualificació Final <span class="text-secondary small">(C. Extraordinària, A. Pèrdua Avaluació Contínua, Convocatòria de gràcia, Recuperació RA complets,...)</span></h2>
